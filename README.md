...
| Métodos                      | Resultado   |
| ---------------------------- | ----------- |
| GET (Filmes)                 | ![Get Filmes](doc/images/image.png)       |
| GET (Filmes{id})             | ![Get Filmes_id](doc/images/image.png)       |
| GET (Genero)                 | ![Get genero](doc/images/image.png)       |
| GET (Genero{id})             | ![Get genero_id](doc/images/image.png)       |
| GET (User)                   | ![Get user](doc/images/image.png)       |
| GET (User{id}{first_name})   | ![Get user_id](doc/images/image.png)       |
| GET (Favoritos{id})          | ![Get Fav_id](doc/images/image.png)       |
| POST (Favoritos{id})         | ![Post Fav_id](doc/images/image.png)       |
| Delete (Favoritos{id})       | ![Delete Fav_id](doc/images/image.png)       |
